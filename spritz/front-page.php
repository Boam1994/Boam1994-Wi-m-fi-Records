    ...
    <div class="hero">
      <div class="slider">
        <ul class="slides">
          <li class="lazy-bg" data-background="<?php echo get_template_directory_uri(); ?>/dummy/slide-1.jpg">
            <div class="container">
          ...
          <li class="lazy-bg" data-background="<?php echo get_template_directory_uri(); ?>/dummy/slide-2.jpg">
            <div class="container">
              <h2 class="slide-title">Header goes here</h2>
              <h3 class="slide-subtitle">Less important text goes here</h3>
              <p class="slide-desc">
          ...
          <li class="lazy-bg" data-background="<?php echo get_template_directory_uri(); ?>/dummy/slide-3.jpg">
            <div class="container">
              <h2 class="slide-title">Header goes here</h2>
              <h3 class="slide-subtitle">Less important text goes here</h3>
              <p class="slide-desc">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="feature">
                <figure class="cut-corner">
                  <img src="<?php echo get_template_directory_uri(); ?>/dummy/medium-image-1.jpg" alt="" />
                </figure>
            ...
            <div class="col-md-4">
              <div class="feature">
                <figure class="cut-corner">
                  <img src="<?php echo get_template_directory_uri(); ?>/dummy/medium-image-2.jpg" alt="" />
                </figure>
                <h3 class="feature-title">
                  Similique sunt in culpa qui officia deserunt mollitia animi
                  laborum dolorum
            ...
            <div class="col-md-4">
              <div class="feature">
                <figure class="cut-corner">
                  <img src="<?php echo get_template_directory_uri(); ?>/dummy/medium-image-3.jpg" alt="" />
                </figure>
                <h3 class="feature-title">
                  Similique sunt in culpa qui officia deserunt mollitia animi
                  laborum dolorum
